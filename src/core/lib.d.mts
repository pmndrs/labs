...
export function generator<T extends Record<string, any>>(
  gen: (state: k_statefull<T>) => Gen,
  opts: k_args<T>
): Promise<stats>;
export function iter<T extends Record<string, any>>(
  iter: (state: k_iter & k_statefull<T>) => any,
  opts: k_args<T>
): Promise<stats>;
...
export function measure<T extends Record<string, any>>(
  gen: (state: k_statefull<T>) => Gen,
  opts: k_args<T>
): Promise<stats>;
export function measure<T extends Record<string, any>>(
